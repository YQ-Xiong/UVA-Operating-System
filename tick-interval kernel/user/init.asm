...
free(void *ap)
{
 ...
 692:	1ea7b783          	ld	a5,490(a5) # 878 <__SDATA_BEGIN__>
 ...
 6c0:	00e6ea63          	bltu	a3,a4,6d4 <free+0x50>
{
 ...
 702:	16f73d23          	sd	a5,378(a4) # 878 <__SDATA_BEGIN__>
}
 706:	6422                	ld	s0,8(sp)
...
malloc(uint nbytes)
{
 ...
 734:	14853503          	ld	a0,328(a0) # 878 <__SDATA_BEGIN__>
 ...
 75c:	12090913          	addi	s2,s2,288 # 878 <__SDATA_BEGIN__>
  if(p == (char*)-1)
 760:	5afd                	li	s5,-1
 ...
 770:	10f73623          	sd	a5,268(a4) # 878 <__SDATA_BEGIN__>
 774:	e39c                	sd	a5,0(a5)
    base.s.size = 0;
 ...
 796:	0ea73323          	sd	a0,230(a4) # 878 <__SDATA_BEGIN__>
      return (void*)(p + 1);
