...
static bool context_switch_test() {
  ...
  asm("sub $8, %%rsp\n\t"
      ...
      : :);
  /*
  printf("b_context is %ld\n", (long)&b_context);
  printf("b_context.rsp is %ld\n", (long)&b_context.rsp);
  printf("b_context.r12 is %ld\n", (long)&b_context.r12);
  printf("b_context.r13 is %ld\n", (long)&b_context.r13);
  printf("b_context.r14 is %ld\n", (long)&b_context.r14);
  printf("b_context.r15 is %ld\n", (long)b_context.r15);


  uint64_t original_r15;
  asm("mov %%r15, %0\n\t": "=m" (original_r15)::);
  printf("original r15 is %ld\n", (long)original_r15);

  uint64_t original_r14;
  asm("mov %%r14, %0\n\t": "=m" (original_r14)::);
  printf("r14 is %ld\n", (long)original_r14);
  */
